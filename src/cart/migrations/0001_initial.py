# Generated by Django 3.0.8 on 2021-12-14 17:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_colour', models.ManyToManyField(to='cart.ColourVariation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_methos', models.CharField(choices=[('paypal', 'tarjeta')], max_length=25)),
